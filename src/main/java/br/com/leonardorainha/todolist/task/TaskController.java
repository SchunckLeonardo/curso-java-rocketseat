...
import br.com.leonardorainha.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity<?> create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if(taskModel.getStartAt().isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A data de início / data de término deve ser menor do que a data de término");
        }
